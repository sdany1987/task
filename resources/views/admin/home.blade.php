        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <span>
                        {{ __('Admin Risk Management') }}
                    </span>
                    <span class="float-end">
                        <a href="{{route('admin.risk.create')}}" title="Create Risk" class="btn btn-info text-white">
...
<script>
    ...
    function viewRiskDet(id) {
      var addrurl = "{{ route('admin.risk.view') }}";
      $.ajax({
         type: "post",
         dataType: 'json',
         url: addrurl,
    ...
    function deleteItem1(fid) {
        var addrurl = "{{ route('admin.risk.delete') }}";
       var text;   
